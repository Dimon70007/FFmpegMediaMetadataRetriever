...
OPENSSL_DEFAULT_CONF="" #"-no-ssl2 -no-ssl3 -no-comp -no-hw"
...
function build_library {
    echo "Building OpenSSL Library for Android Arch $OPENSSL_TARGET_ABI"
...
then
    ...
    ./Configure android-armv7 $OPENSSL_DEFAULT_CONF --openssldir=${OPENSSL_OUTPUT_PATH}
    build_library
...
then
    ...
    export LDFLAGS=" ${ARCH_LINK} "
    cd ${OPENSSL_TMP_FOLDER}
    ./Configure android $OPENSSL_DEFAULT_CONF --openssldir=${OPENSSL_OUTPUT_PATH}
    build_library
...
then
    ...
    ./Configure android-x86 no-asm $OPENSSL_DEFAULT_CONF --openssldir=${OPENSSL_OUTPUT_PATH}
    build_library
...
then
    ...
    export LDFLAGS=" ${ARCH_LINK} "
    cd ${OPENSSL_TMP_FOLDER}
    ./Configure linux-x86_64 $OPENSSL_DEFAULT_CONF --openssldir=${OPENSSL_OUTPUT_PATH}
    build_library
...
then
    ...
    export LDFLAGS=" ${ARCH_LINK} "
    cd ${OPENSSL_TMP_FOLDER}
    ./Configure android-mips $OPENSSL_DEFAULT_CONF --openssldir=${OPENSSL_OUTPUT_PATH}
    build_library
...
then
    ...
    export LDFLAGS=" ${ARCH_LINK} "
    cd ${OPENSSL_TMP_FOLDER}
    ./Configure android-mips64 $OPENSSL_DEFAULT_CONF --openssldir=${OPENSSL_OUTPUT_PATH}
    build_library
